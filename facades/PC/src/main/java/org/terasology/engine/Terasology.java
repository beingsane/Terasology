...
public final class Terasology {
    ...
    public static void main(String[] args) {
        ...
        setMemoryLimit(100);  // TODO: make arg
    ...
    private static void setMemoryLimit(int maxMegabytes) {
        // Memory-limiting techniques are highly platform-specific.
        if (Platform.isLinux()) {
            LibC.Rlimit dataLimit = new LibC.Rlimit();
            dataLimit.rlim_cur = maxMegabytes * 1024 * 1024;
            dataLimit.rlim_max = dataLimit.rlim_cur;
